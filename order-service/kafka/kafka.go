...
func NewKafkaProducer(config *KafkaConfig) (sarama.SyncProducer, error) {
	...
	kafkaConfig.Net.SASL.User = os.Getenv("KAFKA_USERNAME")     // API Key
	kafkaConfig.Net.SASL.Password = os.Getenv("KAFKA_PASSWORD") // API Secret
	kafkaConfig.Net.TLS.Enable = true                           // Enable TLS encryption
